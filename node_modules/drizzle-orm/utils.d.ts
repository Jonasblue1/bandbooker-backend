 ...
 */
export declare const npmVersion = "0.17.0";
export declare function mapResultRow<TResult>(columns: SelectFieldsOrdered<AnyColumn>, row: unknown[], joinsNotNullableMap: Record<string, boolean> | undefined): TResult;
export declare function orderSelectedFields<TColumn extends AnyColumn>(fields: SelectFields<AnyColumn, Table>, pathPrefix?: string[]): SelectFieldsOrdered<TColumn>;
export declare type UpdateSet = Record<string, SQL | Param | null | undefined>;
