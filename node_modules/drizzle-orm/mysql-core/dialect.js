...
class MySqlDialect {
    ...
    buildSelectQuery({ withList, fieldsList: fields, where, table, joins, orderBy, groupBy, limit, offset, lockingClause }) {
        fields.forEach((f) => {
            let tableName;
            if (f.field instanceof column_1.Column
                && (0, table_1.getTableName)(f.field.table)
                    !== (table instanceof subquery_1.Subquery ? table[subquery_1.SubqueryConfig].alias : (0, table_1.getTableName)(table))
