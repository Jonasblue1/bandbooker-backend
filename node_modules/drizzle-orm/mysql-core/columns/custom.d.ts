 ...
 */
export declare function customType<T extends CustomTypeValues>(customTypeParams: CustomTypeParams<T>): (dbName: string, fieldConfig?: T['config']) => MySqlColumnBuilder<ColumnBuilderConfig<CustomColumnBuilderConfig<T>>, Record<string, unknown>>;
