...
exports.getTableChecks = exports.getTableForeignKeys = exports.getTableIndexes = exports.getTableColumns = exports.getTableConfig = void 0;
...
function getTableIndexes(table) {
    const indexes = table[table_1.PgTable.Symbol.Indexes];
...
function getTableForeignKeys(table) {
    const foreignKeys = table[table_1.PgTable.Symbol.ForeignKeys];
...
function getTableChecks(table) {
    const checks = table[table_1.PgTable.Symbol.Checks];
