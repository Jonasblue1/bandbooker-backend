...
export declare class BetterSQLiteSession extends SQLiteSession<'sync', RunResult> {
    private client;
    private logger;
    constructor(client: Database, dialect: SQLiteSyncDialect, options?: BetterSQLiteSessionOptions);
    exec(query: string): void;
    prepareQuery<T extends Omit<PreparedQueryConfig, 'run'>>(query: Query, fields: SelectFieldsOrdered | undefined): PreparedQuery<T>;
}
export declare class PreparedQuery<T extends PreparedQueryConfig = PreparedQueryConfig> extends PreparedQueryBase<{
    ...
    private logger;
    private fields;
    constructor(stmt: Statement, queryString: string, params: unknown[], logger: Logger, fields: SelectFieldsOrdered | undefined);
