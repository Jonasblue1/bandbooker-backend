...
export declare abstract class SQLiteSession<TResultKind extends 'sync' | 'async' = 'sync' | 'async', TRunResult = unknown> {
    ...
    abstract prepareQuery(query: Query, fields: SelectFieldsOrdered | undefined): PreparedQuery<PreparedQueryConfig & {
        type: TResultKind;
    }>;
    prepareOneTimeQuery(query: Query, fields: SelectFieldsOrdered | undefined): PreparedQuery<PreparedQueryConfig & {
        type: TResultKind;
    }>;
