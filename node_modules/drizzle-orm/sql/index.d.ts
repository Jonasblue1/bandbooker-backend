...
export declare type QueryTypingsValue = 'json' | 'decimal' | 'time' | 'timestamp' | 'uuid' | 'date' | 'none';
...
export declare class SQL<T = unknown> implements SQLWrapper {
    ...
    toQuery({ escapeName, escapeParam, paramStartIndex }: BuildQueryConfig, prepareTyping?: (encoder: DriverValueEncoder<unknown, unknown>) => QueryTypingsValue): Query;
    getSQL(): SQL;
...
export declare type GetDecoderResult<T> = T extends DriverValueDecoder<infer TData, any> | DriverValueDecoder<infer TData, any>['mapFromDriverValue'] ? TData : never;
/**
...
export declare type SQLSourceParam = SQLSourceParam[] | SQLWrapper | SQL | Table | Subquery | AnyColumn | Param | Name | undefined | FakePrimitiveParam | Placeholder;
